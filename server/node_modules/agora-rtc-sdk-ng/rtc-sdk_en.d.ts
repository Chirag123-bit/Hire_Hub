 ...
 *
 * Occurs when the SDK switches to TCP/TLS 443.
 *
 * After you call [[join]], the SDK attempts a direct connection to Agora SD-RTN™. If the attempt fails, it automatically switches to TCP/TLS 443. The auto-switch function is disabled by default. To enable this function, contact support@agora.io.
 *
